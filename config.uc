...
const meshtasticprotobufs = require("meshtasticprotobufs");
...
const device = require("telemetry_device");
const environmental_weewx = require("telemetry_environmental_weewx");
const airquality_purpleair = require("telemetry_airquality_purpleair");
